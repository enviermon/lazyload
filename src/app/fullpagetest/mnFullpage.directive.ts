...
import {Directive, Input, OnInit, ElementRef, OnChanges, AfterViewInit} from '@angular/core';
...
export class MnFullpageDirective implements OnInit, OnChanges , AfterViewInit{
